...
function App() {
  ...
  const models = [
    ...
    { name: 'Espírito Santo', file: 'espiritoSanto.glb', thumbnail: 'espiritoSanto.webp', position: [0, -1, 0], rotation: [0, 0, 0] },
    { name: 'Ferro', file: 'ferro.glb', thumbnail: 'ferro.webp', position: [0, -1, 0], rotation: [0, 0, 0] },
    { name: 'Incenso', file: 'incenso.glb', thumbnail: 'incenso.webp', position: [0, -1, 0], rotation: [0, 0, 0] },
    ...
    { name: 'Pilão', file: 'pilao.glb', thumbnail: 'pilao.webp', position: [0, -1, 0], rotation: [0, 0, 0] },
    ...
    { name: 'Xícara', file: 'xicara.glb', thumbnail: 'xicara.webp', position: [0, -1, 0], rotation: [0, 0, 0] },
  ];
